...
This chapter is about building intuitions for making these kinds of inferences about the role of chance in your data. What you are about to read is a way of doing statistical inference without using most of the jargon that we normally use to talk about it. The goal is to work without formulas or probabilities, and just use simulations to see what happens. We will look at what chance can do, then we will talk about what needs to happen in your data in order for you to be confident that chance didn't do it.
...
"What grey areas are you talking about?, I only see red or green, am I grey blind?". Let's look at where some grey areas might be. I say might be, because people disagree about where the grey is. People have different comfort levels with grey. @fig-5simuncertainty shows my opinion on grey areas.
