...
g1 <- qplot(x=happiness, fill=I("darkslategray3"), color=I("black"), bins=5)+
  theme_classic(base_size=12)+
  theme(legend.position="none")

g2 <- qplot(x=happiness, fill=I("darkslategray3"), color=I("black"),bins=10)+
  theme_classic(base_size=12)+
  theme(legend.position="none")

g3 <- qplot(x=happiness, fill=I("darkslategray3"), color=I("black"), bins=20)+
  theme_classic(base_size=12)+
  theme(legend.position="none")

g4 <- qplot(x=happiness, fill=I("darkslategray3"), color=I("black"), bins=50)+
  theme_classic(base_size=12)+
  theme(legend.position="none")
