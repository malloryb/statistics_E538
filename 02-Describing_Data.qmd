---
author: Matthew J. C. Crump, Mallory L. Barnes
...
#| fig.alt: "Histogram charting 'exp_num' (0-60) on the x-axis against frequency on the y-axis, data clusters near zero with a long right tail. Horizontal lines denote the mode (blue) near 1, median (green) at 6, and mean (red) at 8, illustrating the disparity among these measures of central tendency"  
