...
g1 <- qplot(x=happiness, color="white", fill="darkslategray3", bins=5)+
  theme_classic()+
  theme(legend.position="none")

g2 <- qplot(x=happiness, color="white", fill="darkslategray3",bins=10)+
  theme_classic()+
  theme(legend.position="none")

g3 <- qplot(x=happiness, color="white", fill="darkslategray3", bins=20)+
  theme_classic()+
  theme(legend.position="none")

g4 <- qplot(x=happiness, color="white", fill="darkslategray3", bins=50)+
  theme_classic()+
  theme(legend.position="none")
