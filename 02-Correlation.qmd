...
#| fig-cap: "Completely random data points drawn from a uniform distribution with a small sample size of 10. The blue line twirls around sometimes showing large correlations that are produced by chance"
#| out.width: "75%"
...
::: {.content-visible when-format="pdf"}
![Completely random data points drawn from a uniform distribution with a small sample size of 10. The blue line twirls around sometimes showing large correlations that are produced by chance (Final frame; the animated version is in the web edition of this book.)](imgs/gifs/stills/corUnifn10-1.png){#fig-3randcor10gif width=75%}
:::
...
**Takeaway.** Correlation summarizes linear association precisely, but it is only as trustworthy as your plot, your sample size, and your awareness of curvature and confounding.
