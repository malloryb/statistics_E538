...
::: callout-important
**Reporting this result.** These tests report differently from a $t$-test, and the difference matters: there is no mean difference to quote, because none of them used the means. Give the test's own statistic, the $p$-value, and a **median** rather than a mean.
