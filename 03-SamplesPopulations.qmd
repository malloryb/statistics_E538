...
These rules look abstract at first, but they are just formal ways of describing common-sense situations. Let's work through them with our ice cream example, so the notation stays tied to something you can picture.
...
Note that *and* means overlap here, not "add the probabilities together."
...
*Or* covers everything in either group. We subtract the overlap $A \cap B$ so we don't double-count it.
