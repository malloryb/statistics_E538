...
In @fig-4sampledistmeannorm, we are sampling from a *normal* distribution (orange line). The sampling distribution of the mean (green bars) is also normal.
...
Let's try sampling from a uniform population: the parent distribution is flat (orange), but the sampling distribution of the mean is bell-shaped (@fig-4samplemeanunif).
