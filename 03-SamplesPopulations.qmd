...
::: callout-note
## Connecting back to the law of large numbers

Earlier in this chapter we met the **law of large numbers** and the **central limit theorem**. Both connect directly to what we just saw:

-   **Law of large numbers:** as $n$ grows, both $\bar{x}$ and $s_{n-1}$ converge toward their true population values. That is exactly the pattern in @fig-sdbias-simulation: bigger samples, tighter histograms, less bias.
