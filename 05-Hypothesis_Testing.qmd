...
#| fig-cap: 'The two sampling distributions of the sample mean from Chapter 4. The distance between them, in standard errors, decides the test: past 1.96, reject $H_0$.'
...
knitr::include_graphics("imgs/gifs/ch5_recap.gif")
```
