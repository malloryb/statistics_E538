...
@fig-5.5powercurveN plots power against sample size for detecting $d=0.2$. The dashed line marks 80% power, a common planning target.

```{r}
#| label: fig-5.5powercurveN
#| fig-cap: 'Power vs. sample size for detecting $d=0.2$ with a two-sample $t$-test at $\alpha=0.05$; dashed line marks $0.80$ power.'
