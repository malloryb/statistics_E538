...
@fig-5.5effectsizeType1 shows the first pitfall graphically. Even when the null hypothesis is true, 5% of tests are expected to fall below $\alpha = 0.05$. In small samples, those false positives tend to be paired with large apparent effect sizes. What looks like a strong finding could just be sampling error.
