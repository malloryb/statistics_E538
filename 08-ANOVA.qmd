...
#| fig-alt: "Histogram of 10,000 simulated F values from a null distribution. The histogram starts at zero, rises to a tall peak below 1, and then tapers off in a long right-hand tail, with very few values reaching as high as 5."
#| fig-asp: 0.5
#| out-width: "100%"
...
#| fig-alt: "Ten small panels, each plotting three group means with standard-error bars for site types A, B, and C. In most panels the error bars for the three points overlap heavily; in a few panels they overlap less, making the means look more separated even though every panel was generated with no real difference between groups."
#| out-width: "100%"
...
ggplot(data = plot_df2, aes(x = site_type, y = group_means)) +
  ...
  geom_errorbar(aes(ymin = group_means - group_SE, ymax = group_means +
                      group_SE), color = "#10377f", width = 0.25) +
  xlab("Site type") +
  ylab("Mean abundance") +
...
#| fig-alt: "Ten small panels of blue bar charts with three bars each for site types A, B, and C, all filtered to simulations where F was less than 1. Within every panel the three bars sit at similar heights and their error bars overlap heavily, showing no visual separation between the group means."
#| out-width: "100%"
