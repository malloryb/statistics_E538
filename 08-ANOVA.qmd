...
$SS_\text{Between}$ is the variation the group means explain and $SS_\text{Total}$ is all the variation there is, so $\eta^2$ is the proportion of the total variation attributable to the grouping variable. It runs from 0 to 1.
