...
::: callout-important
**Reporting this result.** Report the direction in plain language, the test statistic with both degrees of freedom, the error term, $p$, and the effect size.
...
knitr::kable(
  data.frame(
    ...
    `SS Total`   = round(ss_between + ss_within, 2),
