...
abstract: Sections 4.1 & 4.9 - Adapted text by Danielle Navarro Section 4.10 - 4.11 & 4.13 - Mix of Matthew Crump & Danielle Navarro Section 4.12 - 4.13 - Adapted text by Danielle Navarro, all sections modified by Mallory Barnes. 
...
[Tighten up but the distinction is useful]
...
[Tighten up but the destinction is useful]
...
Suppose we track which ice cream flavor a customer chooses: chocolate, vanilla, or strawberry. Each choice is an *elementary event*, and the set of all possible events is the *sample space*:
...
Flavor Probability - Chocolate $P(\text{choc})=0.5$ - Vanilla $P(\text{van})=0.3$ - Strawberry $P(\text{straw})=0.2$
