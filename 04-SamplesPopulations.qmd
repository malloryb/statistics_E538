...
Now let's revisit the rules with actual numbers:
...
*Explanation*: the chance of not choosing chocolate, vanilla, or strawberry is the chance of Rocky Road).
...
*Explanation*: The only overlap is chocolate: $A \cap B = (\text{chocolate}) So P(A \cap B) = 0.4$ •

$A$ or $B$ $A \cup B = (\text{chocolate, vanilla, strawberry, rocky road})$

Which is everything, so $P(A \cup B)$ = 1 •
