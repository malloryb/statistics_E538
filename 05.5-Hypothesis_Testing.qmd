...
#| out-width: "100%"
#| 
p4 <-  plot_distributions(null_mean=0.5, null_sd=1, sample_mean=0.51, sample_sd=0.3, inferred_mean=0.51, inferred_sd=1, true_mean=0.52, true_sd=1)
print(p4)
...
In the figures below, blue lines represent the null parent distribution (defined by the null mean and the sample's standard deviation). The green solid lines denote the apparent parent distribution of our sample:

- **Solid green line**: Represents the distribution described by our sample mean and standard deviation.
...
plot_distributions_no_error(null_mean=0, null_sd=1, sample_mean=-0.5, sample_sd=0.7, inferred_mean=-0.5, inferred_sd=1)
...
p11 <-  plot_distributions(null_mean=0, null_sd=1, sample_mean=1, sample_sd=0.3, inferred_mean=1, inferred_sd=1, true_mean=0, true_sd=1)
print(p11)
```
...
p12 <-  plot_distributions(null_mean=0, null_sd=1, sample_mean=0.5, sample_sd=0.8, inferred_mean=0.5, inferred_sd=1, true_mean=3, true_sd=1)
print(p12)
```
...
p13 <-  plot_distributions(null_mean=0, null_sd=1, sample_mean=0.5, sample_sd=0.3, inferred_mean=0.5, inferred_sd=1, true_mean=3, true_sd=1)
print(p13)
```
