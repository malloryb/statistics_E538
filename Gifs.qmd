...
anim<-ggplot(d, aes(x = hp, y = mpg, frame=sims)) +
  ...
  geom_segment(aes(xend = hp, yend = predicted+move_line_sims), color = "#b22222", alpha = .5) +
  geom_point() +
...
ggplot(all_df, aes(x=sample))+
  geom_histogram(aes(y=(..density..)/max(..density..)^.8),color="white",fill="grey70")+
  geom_histogram(aes(x=sample_means,y=(..density..)/max(..density..)),fill="#008cff",color="white",alpha=.6)+
