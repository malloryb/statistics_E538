...
Usually, nobody in that scenario wants to find an interaction; they want a clean, adjusted comparison of the two treatments.
...
-   Homogeneity of slopes: the groups share that same line, unless the interaction test says otherwise *(new --- this is the one the interaction test above directly checks, rather than a condition you verify beforehand)*
