...
-   **A covariate also shrinks the error term.** Variation the covariate explains leaves $MS_\text{Within}$, which is the same way repeated-measures ANOVA gains power by removing unit-to-unit variation.
