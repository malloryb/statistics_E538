...
::: callout-warning
**The other way you'll see ANCOVA.** Elsewhere the covariate is a **nuisance** instead: something you control for so a group comparison comes out fairer, with an interaction being a box you check and hope stays empty.
