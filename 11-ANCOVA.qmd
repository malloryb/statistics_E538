...
We'll fit an ANCOVA model to test whether location type influences bird density **after accounting for** air pollution. The categorical variable is represented as a dummy variable, and air pollution enters as a covariate.
