...
#| fig-alt: "A blue t-distribution curve with 9 degrees of freedom. Red vertical lines mark the critical values near plus and minus 2.26, and the two tails beyond them are shaded red and labeled 'rejection region.' The middle of the curve is labeled 'retain H0.'"
#| out-width: "80%"
...
ggplot(t_tibble, aes(x, y)) +
  ...
  annotate("segment", x = c(-crit, crit), xend = c(-crit, crit), y = 0,
           yend = dt(crit, df), colour = "red", linewidth = 0.8) +
  ...
  annotate("text", x = 2.2, y = 0.33, label = "'Under '*H[0]", parse = TRUE, colour = "blue", hjust = 0, size = 4.2) +
  labs(x = "t", y = "Density") +
  theme_classic(base_size = 12)
```
