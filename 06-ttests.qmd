...
::: callout-tip
**What you will report.** Always report:
...
ggplot(plot_df, aes(x = range, y = null_distribution)) +
  ...
  theme_classic(base_size = 12) +
  theme(axis.text.y = element_blank(), axis.ticks = element_blank()) +
  annotate("rect", xmin = qt(.95, 9, lower.tail = TRUE), xmax = 3, ymin = 0, ymax = Inf, alpha = 0.5, fill = "green") +
...
ggplot(plot_df, aes(x = range, y = null_distribution)) +
  ...
  theme_classic(base_size = 12) +
  theme(axis.text.y = element_blank(), axis.ticks = element_blank()) +
  annotate("rect", xmin = qt(.975, 9, lower.tail = TRUE), xmax = 4, ymin = 0, ymax = Inf, alpha = 0.5, fill = "green") +
  annotate("rect", xmin = -4, xmax = qt(.025, 9, lower.tail = TRUE), ymin = 0, ymax = Inf, alpha = 0.5, fill = "green") +
...
::: callout-important
**Reporting this result.** All three forms report the same four things: the direction in plain language, the effect size, the test statistic with its df, and $p$. What changes is what counts as the effect.
