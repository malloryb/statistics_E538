...
::: callout-warning
**Beyond ruling out chance.** Ruling out chance is not all that statistics does. The same tools generalize to asking which of several competing models could have produced the data, weighing them against each other rather than only rejecting the unlikely one. Those methods are beyond this book.
:::
