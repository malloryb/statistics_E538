...
```{r}
#| label: fig-5gumballA
#| fig-cap: "Mean pH for two groups drawn from the same stream population. Note the zoomed y-axis, which does not start at 0."
...
#| fig-cap: "Ten replications of sampling pH at 10 stream sites and splitting them arbitrarily into two groups of 5. Every difference here is chance alone."
#| out-width: "100%"
