...
players <- data.frame(
  group = c("The hypothesis", "The hypothesis", "The truth", "The sample", "The sample", "The sample", "The sample", "For testing"),
  line = "",
...
**5. The same move on the null side.** Divide the null population's standard deviation by $\sqrt{n}$ and you get the **sampling distribution of the sample mean under $H_0$** (blue dot-dash): centered at $\mu_0$, and much narrower. It describes where $\bar{x}$ would land across many samples if $H_0$ were true, which makes it the formal version of the chance window. The critical values in Route 1 come from it.
...
ggplot(null_pair, aes(x, y, color = curve, linetype = curve)) +
  ...
  annotate("segment", x = 0, xend = 0, y = 0, yend = dnorm(0, 0, 1), linetype = "dashed", color = "magenta", linewidth = 1) +
  scale_color_manual(values = c("Null Population Distribution" = "blue",
