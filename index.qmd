...
Welcome to the Fall 2026 edition of this Open Educational Resource (OER) textbook, specifically adapted for Environmental Science students enrolled in the SPEA E-538 statistics course at Indiana University (IU).

This textbook is an adaptation of a thorough introductory statistics textbook originally developed for undergraduate Psychology students by Matthew Crump and colleagues (refer to Acknowledgements for more details). As part of IU's Course Materials Fellowship Program ([CMFP](https://libraries.indiana.edu/course-material-fellowship-program-1)), I adapted this material for students studying Environmental Science.

**Online Textbook**:<https://malloryb.github.io/statistics_E538/>

**How to cite this book**: Barnes, M. L. (2026). *Statistics for Environmental Science* (Fall 2026 edition). Indiana University. <https://malloryb.github.io/statistics_E538/>

**First published**: 2023, for SPEA E-538 at Indiana University.
...
This textbook was written in RStudio, using Quarto, and compiled into a web-book format. In general, I thank the larger R community for all of the amazing tools they made, and for making those tools open, so that I could use them to make this thing.
