...
- there is no difference between the means for each level of soil type, H~o~: $\mu_{Clay} = \mu_{Loam} = \mu_{Sand}$\

- there is no difference between the means for each level of irrigation, \$H~o~: $\mu_{Drip} = \mu_{Sprinkler}$\
